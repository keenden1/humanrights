    ...
    <div class="col-md-3 left_col">
      <div class="left_col scroll-view">
        <div class="navbar nav_title" style="border: 0;">
          <a  class="site_title"><img src="logo/logo.png" alt=""><span class="hoy"> <p>{{$admin_username}}</p></span></a>
        </div>
        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
          <div class="menu_section">
            ...
            <ul class="nav side-menu">
              <li><a href="{{ url('Legal-Head-Dashboard') }}"><i class="fa fa-home"></i> Dashboard </a></li>
              <li><a  class="toggle-menu"id="formMenuToggle"><i class="fa fa-edit"></i> Complaint <span class="fa fa-chevron-down"></span></a>
               <ul class="child">
                  <li><a href="{{ url('Legal-Head-Form') }}">Form</a></li>
                  <li><a href="{{ url('Legal-Head-Case') }}">Case</a></li>
                </ul>
              </li>
              <li><a href="{{ url('Legal-Head-Report') }}"><i class="fa-solid fa-file-circle-exclamation"></i> Report </a></li>
              <li><a href="{{ url('Legal-Head-Setting') }}"><i class="fa-solid fa-gear"></i> Settings </a></li>
            </ul>
          </div>
