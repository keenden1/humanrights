    ...
    <div class="col-md-3 left_col">
      <div class="left_col scroll-view">
        <div class="navbar nav_title" style="border: 0;">
          <a  class="site_title"><img src="logo/logo.png" alt=""><span class="hoy"> <p>Admin</p></span></a>
        </div>
        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
          <div class="menu_section">
            ...
            <ul class="nav side-menu">
              ...
              <li><a href="{{ url('Admin-Endorse') }}"><i class="fa-solid fa-file-pen"></i> Endorse </a></li>
              <li><a href="{{ url('Admin-Employee') }}"></i> Employee </a></li>
              <li><a href="{{ url('Admin-Case') }}"><i class="fa-solid fa-list-check"></i> Case </a></li>
              <li><a href="{{ url('Admin-Reports') }}"><i class="fa-solid fa-file-circle-exclamation"></i> Report </a></li>
              <li><a href="{{ url('Admin-Setting') }}"><i class="fa-solid fa-gear"></i> Settings </a></li>
            </ul>
          </div>
