...
<div class="float-float">
    <p>FORM 10 - COMPLAINT FORM(MINOR AGE)</p>
</div>
        ...
        <table id="employee-table">
            <thead>
                <tr>
                    ...
                    <th data-column="title" data-order="desc">Cases<i class="fas fa-sort"></i></th>
            ...
            @foreach($cases as $case)
                <tr>
                    ...
                    <td style="text-align: center;"> <button class="messaging" id="showPopupButton"  data-ref="{{ $case->reference_number }}"
                    data-admin_username="{{ $case->admin_username }}">Endorse</button></td>
                    @endif
                </tr>             
                @endforeach
                @endif
...
<div class="overlay" id="overlay"></div>
    ...
    <table>
        ...
        <tr>       <input type="hidden" id="popup-summary" >
