        ...
        @endif
            ...
            <form action="{{ route('send.otp') }}" method="POST">
                ...
                <div class="reset-input-email">
                    <!-- Pass the email from the query string to the input field -->
                    <input type="email" name="user_email" value="{{ request()->get('email') }}" placeholder="e.g. howard.thurman@gmail.com" required readonly >
                </div>
                <hr>
