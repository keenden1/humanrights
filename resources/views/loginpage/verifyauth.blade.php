...
<div id="verify-panel">
    <section class="verify-panel">
            <span>
                ...
                <div class="verify-panel-head">
                <p><strong>Verification Account</strong></p>
                </div>
                @if ($errors->any())
            ...
            <span><p>Email</p></span>
            <span>
            <form action="{{ route('verify.otpotpauth') }}" method="POST">
            @csrf
            ...
            <span><p>Please Enter The Code</p></span>
            <span>
...
.error-messages li {
    margin: 5px 0; /* Space between each error message */
}
